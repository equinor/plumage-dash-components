...
Plumage Dash Components is a Dash component library.
...
### Write your component code in `src/lib/components/PlumageDashComponents.react.js`.
...
3. Test your tarball by copying it into a new environment and installing it locally:
    ```
    $ pip install plumage_dash_components-0.0.1.tar.gz
    ```
